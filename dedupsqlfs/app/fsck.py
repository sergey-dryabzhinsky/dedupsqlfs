...
def main(): # {{{1
    ...
    parser.add_argument('--compress', dest='compression_method', metavar='METHOD',
    ...
    parser.add_argument('--minimal-compress-size', dest='compression_minimal_size', metavar='BYTES', type=int,
                        default=-1,
                        help="Minimal block data size for compression. Defaults to -1 bytes (auto). Do not compress if data size is less than BYTES long. If not forced to.")
