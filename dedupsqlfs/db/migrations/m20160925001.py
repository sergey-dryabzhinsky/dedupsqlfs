# -*- coding: utf8 -*-
#
# DB migration 001 by 2016-09-25
#
# - Rename current ZSTD compression into 'zstd061'
# - Add new 'zstd' compression for 1.0+
#
__author__ = 'sergey'

__NUMBER__ = 20160925001
...
def run(manager):
    ...
    try:
        ...
        if not table_ct.find('zstd061'):
            cur = table_ct.getCursor()

            cur.execute("UPDATE compression_type SET value='zstd061' WHERE value='zstd';")
