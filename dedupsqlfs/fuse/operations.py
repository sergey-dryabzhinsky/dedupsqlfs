...
class DedupOperations(llfuse.Operations): # {{{1
    ...
    def __get_block_data_by_offset(self, inode, offset, size):
        ...
        first_block_number = (offset - inblock_offset) / self.block_size
        raw_data = BytesIO()
    ...
    def __flush_old_cached_blocks(self, cached_blocks):
        count = 0
